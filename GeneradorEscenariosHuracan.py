...
class ScenarioGenerator:
    ...
    def generate_scenarios(
        ...
        for c in range(k):
            ...
            # Demand factor: scales with category and transit hours
            avg_transit = np.mean([imp.transit_hours for imp in cluster_impacts])
            demand_factor = 0.6 + 0.15 * avg_cat + 0.005 * avg_transit
            ...
            scenarios.append(Scenario(
                ...
                parameters={
                    ...
                    "avg_transit_h": round(float(avg_transit), 1),
                    "horizon_noise": noise,
